...
const entityPath = path.join(__dirname, `../src/domain/entities/${pascalName}.ts`);
const entity = getFileContent(path.join(__dirname, './domain/Entity.tmp'));

const repositoryInterfacePath = path.join(__dirname, `../src/application/interfaces/repositories/I${pascalName}Repository.ts`);
const repositoryInterface = getFileContent(path.join(__dirname, './application/interfaces/IRepository.tmp'));

const findHandlerUsecaseSpecPath = path.join(__dirname, `../src/application/usecases/${folder}/find-${subFolder}/${findUsecaseFncName}Handler.spec.ts`);
...
const findHandlerUsecasePath = path.join(__dirname, `../src/application/usecases/${folder}/find-${subFolder}/${findUsecaseFncName}Handler.ts`);
const findHandlerUsecase = getFileContent(path.join(__dirname, './application/usecases/find/FindHandler.tmp'));

const findInputUsecasePath = path.join(__dirname, `../src/application/usecases/${folder}/find-${subFolder}/${findUsecaseFncName}Input.ts`);
const findInputUsecase = getFileContent(path.join(__dirname, './application/usecases/find/FindInput.tmp'));

const findOutputUsecasePath = path.join(__dirname, `../src/application/usecases/${folder}/find-${subFolder}/${findUsecaseFncName}Output.ts`);
const findOutputUsecase = getFileContent(path.join(__dirname, './application/usecases/find/FindOutput.tmp'));

const getHandlerUsecaseSpecPath = path.join(__dirname, `../src/application/usecases/${folder}/get-${subFolder}/${getUsecaseFncName}Handler.spec.ts`);
...
const getHandlerUsecasePath = path.join(__dirname, `../src/application/usecases/${folder}/get-${subFolder}/${getUsecaseFncName}Handler.ts`);
const getHandlerUsecase = getFileContent(path.join(__dirname, './application/usecases/get/GetHandler.tmp'));

const getOutputUsecasePath = path.join(__dirname, `../src/application/usecases/${folder}/get-${subFolder}/${getUsecaseFncName}Output.ts`);
const getOutputUsecase = getFileContent(path.join(__dirname, './application/usecases/get/GetOutput.tmp'));

const createHandlerUsecasePath = path.join(__dirname, `../src/application/usecases/${folder}/create-${subFolder}/${createUsecaseFncName}Handler.ts`);
const createHandlerUsecase = getFileContent(path.join(__dirname, './application/usecases/create/CreateHandler.tmp'));

const createHandlerUsecaseSpecPath = path.join(__dirname, `../src/application/usecases/${folder}/create-${subFolder}/${createUsecaseFncName}Handler.spec.ts`);
...
const createInputUsecasePath = path.join(__dirname, `../src/application/usecases/${folder}/create-${subFolder}/${createUsecaseFncName}Input.ts`);
const createInputUsecase = getFileContent(path.join(__dirname, './application/usecases/create/CreateInput.tmp'));

const createOutputUsecasePath = path.join(__dirname, `../src/application/usecases/${folder}/create-${subFolder}/${createUsecaseFncName}Output.ts`);
const createOutputUsecase = getFileContent(path.join(__dirname, './application/usecases/create/CreateOutput.tmp'));

const updateHandlerUsecaseSpecPath = path.join(__dirname, `../src/application/usecases/${folder}/update-${subFolder}/${updateUsecaseFncName}Handler.spec.ts`);
...
const updateHandlerUsecasePath = path.join(__dirname, `../src/application/usecases/${folder}/update-${subFolder}/${updateUsecaseFncName}Handler.ts`);
const updateHandlerUsecase = getFileContent(path.join(__dirname, './application/usecases/update/UpdateHandler.tmp'));

const updateInputUsecasePath = path.join(__dirname, `../src/application/usecases/${folder}/update-${subFolder}/${updateUsecaseFncName}Input.ts`);
const updateInputUsecase = getFileContent(path.join(__dirname, './application/usecases/update/UpdateInput.tmp'));

const updateOutputUsecasePath = path.join(__dirname, `../src/application/usecases/${folder}/update-${subFolder}/${updateUsecaseFncName}Output.ts`);
const updateOutputUsecase = getFileContent(path.join(__dirname, './application/usecases/update/UpdateOutput.tmp'));

const deleteHandlerUsecaseSpecPath = path.join(__dirname, `../src/application/usecases/${folder}/delete-${subFolder}/${deleteUsecaseFncName}Handler.spec.ts`);
...
const deleteHandlerUsecasePath = path.join(__dirname, `../src/application/usecases/${folder}/delete-${subFolder}/${deleteUsecaseFncName}Handler.ts`);
const deleteHandlerUsecase = getFileContent(path.join(__dirname, './application/usecases/delete/DeleteHandler.tmp'));

const deleteOutputUsecasePath = path.join(__dirname, `../src/application/usecases/${folder}/delete-${subFolder}/${deleteUsecaseFncName}Output.ts`);
const deleteOutputUsecase = getFileContent(path.join(__dirname, './application/usecases/delete/DeleteOutput.tmp'));

// Infrastructure

const schemaPath = path.join(__dirname, `../src/infras/data/typeorm/schemas/${pascalName}Schema.ts`);
const schema = getFileContent(path.join(__dirname, './data/Schema.tmp'));

const entityDbPath = path.join(__dirname, `../src/infras/data/typeorm/entities/${pascalName}Db.ts`);
const entityDb = getFileContent(path.join(__dirname, './data/EntityDb.tmp'));

const repositorySpecPath = path.join(__dirname, `../src/infras/data/typeorm/repositories/${pascalName}Repository.spec.ts`);
const repositorySpec = getFileContent(path.join(__dirname, './data/Repository.spec.tmp'));

const repositoryPath = path.join(__dirname, `../src/infras/data/typeorm/repositories/${pascalName}Repository.ts`);
const repository = getFileContent(path.join(__dirname, './data/Repository.tmp'));

// Expose

const controllerSpecPath = path.join(__dirname, `../src/exposes/${exposeType}/${exposeSubType}/controllers/${pascalName}Controller.spec.ts`);
const controllerSpec = getFileContent(path.join(__dirname, './api/Controller.spec.tmp'));

const controllerPath = path.join(__dirname, `../src/exposes/${exposeType}/${exposeSubType}/controllers/${pascalName}Controller.ts`);
