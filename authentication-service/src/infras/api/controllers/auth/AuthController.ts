...
import { CreateAuthByEmailCommandOutput } from '@usecases/auth/auth/commands/create-auth-by-email/CreateAuthByEmailCommandOutput';
...
export class AuthController {
    ...
    @ResponseSchema(CreateAuthByEmailCommandOutput)
    async createUserAuth(@Body() param: CreateAuthByEmailCommandInput, @HandleOptionRequest() handleOption: HandleOption): Promise<CreateAuthByEmailCommandOutput> {
        return await this._createAuthByEmailCommandHandler.handle(param, handleOption);
    }
    ...
    async forgotPassword(@Body() param: ForgotPasswordByEmailCommandInput, @HandleOptionRequest() handleOption: HandleOption): Promise<ForgotPasswordByEmailCommandOutput> {
        return await this._forgotPasswordByEmailCommandHandler.handle(param, handleOption);
    }
