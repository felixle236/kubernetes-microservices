...
const usecaseHandlerSpecPath = path.join(__dirname, `../src/application/usecases/${folder}/${usecaseFncFolder}/${usecaseFncName}Handler.spec.ts`);
...
const usecaseHandlerPath = path.join(__dirname, `../src/application/usecases/${folder}/${usecaseFncFolder}/${usecaseFncName}Handler.ts`);
const usecaseHandler = getFileContent(path.join(__dirname, `./application/usecases/${methodNameLowerCase}/${methodName}Handler.tmp`));

const usecaseOutputPath = path.join(__dirname, `../src/application/usecases/${folder}/${usecaseFncFolder}/${usecaseFncName}Output.ts`);
...
if (['find', 'create', 'update'].includes(methodNameLowerCase)) {
    const usecaseInputPath = path.join(__dirname, `../src/application/usecases/${folder}/${usecaseFncFolder}/${usecaseFncName}Input.ts`);
