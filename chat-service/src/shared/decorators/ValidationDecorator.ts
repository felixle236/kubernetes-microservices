...
export const IsMobilePhone = (locale?: ValidatorJS.MobilePhoneLocale, mOpts?: ValidatorJS.IsMobilePhoneOptions, opts?: classValidator.ValidationOptions): PropertyDecorator =>
    classValidator.IsMobilePhone(locale, mOpts, { ...opts, message: intlMsg('is_mobile_phone', { locale }) });
