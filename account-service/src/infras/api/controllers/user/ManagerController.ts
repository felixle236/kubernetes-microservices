...
export class ManagerController {
    ...
    async create(@Body() param: CreateManagerCommandInput, @HandleOptionRequest() handleOption: HandleOption): Promise<CreateManagerCommandOutput> {
        return await this._createManagerCommandHandler.handle(param, handleOption);
    }
    ...
    async update(@Param('id') id: string, @Body() param: UpdateManagerCommandInput, @HandleOptionRequest() handleOption: HandleOption): Promise<UpdateManagerCommandOutput> {
        return await this._updateManagerCommandHandler.handle(id, param, handleOption);
    }
    ...
    async updateMyProfile(@Body() param: UpdateMyProfileManagerCommandInput, @CurrentUser() userAuth: UserAuthenticated, @HandleOptionRequest() handleOption: HandleOption): Promise<UpdateMyProfileManagerCommandOutput> {
        return await this._updateMyProfileManagerCommandHandler.handle(userAuth.userId, param, handleOption);
    }
    ...
    async delete(@Param('id') id: string, @HandleOptionRequest() handleOption: HandleOption): Promise<DeleteManagerCommandOutput> {
        return await this._deleteManagerCommandHandler.handle(id, handleOption);
    }
    ...
    async archive(@Param('id') id: string, @HandleOptionRequest() handleOption: HandleOption): Promise<ArchiveManagerCommandOutput> {
        return await this._archiveManagerCommandHandler.handle(id, handleOption);
    }
}
