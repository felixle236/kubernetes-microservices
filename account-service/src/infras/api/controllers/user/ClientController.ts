...
export class ClientController {
    ...
    async register(@Body() param: RegisterClientCommandInput, @HandleOptionRequest() handleOption: HandleOption): Promise<RegisterClientCommandOutput> {
        return await this._registerClientCommandHandler.handle(param, handleOption);
    }

    @Post('/active')
    @OpenAPI({ summary: 'Active client account' })
    @ResponseSchema(ActiveClientCommandOutput)
    async active(@Body() param: ActiveClientCommandInput, @HandleOptionRequest() handleOption: HandleOption): Promise<ActiveClientCommandOutput> {
        return await this._activeClientCommandHandler.handle(param, handleOption);
    }

    @Post('/resend-activation')
    @OpenAPI({ summary: 'Resend activation for client' })
    @ResponseSchema(ResendActivationCommandOutput)
    async resendActivation(@Body() param: ResendActivationCommandInput, @HandleOptionRequest() handleOption: HandleOption): Promise<ResendActivationCommandOutput> {
        return await this._resendActivationCommandHandler.handle(param, handleOption);
    }
    ...
    async create(@Body() param: CreateClientCommandInput, @HandleOptionRequest() handleOption: HandleOption): Promise<CreateClientCommandOutput> {
        return await this._createClientCommandHandler.handle(param, handleOption);
    }
    ...
    async update(@Param('id') id: string, @Body() param: UpdateClientCommandInput, @HandleOptionRequest() handleOption: HandleOption): Promise<UpdateClientCommandOutput> {
        return await this._updateClientCommandHandler.handle(id, param, handleOption);
    }
    ...
    async updateMyProfile(@Body() param: UpdateMyProfileClientCommandInput, @CurrentUser() userAuth: UserAuthenticated, @HandleOptionRequest() handleOption: HandleOption): Promise<UpdateMyProfileClientCommandOutput> {
        return await this._updateMyProfileClientCommandHandler.handle(userAuth.userId, param, handleOption);
    }
    ...
    async delete(@Param('id') id: string, @HandleOptionRequest() handleOption: HandleOption): Promise<DeleteClientCommandOutput> {
        return await this._deleteClientCommandHandler.handle(id, handleOption);
    }
    ...
    async archive(@Param('id') id: string, @HandleOptionRequest() handleOption: HandleOption): Promise<ArchiveClientCommandOutput> {
        return await this._archiveClientCommandHandler.handle(id, handleOption);
    }
}
