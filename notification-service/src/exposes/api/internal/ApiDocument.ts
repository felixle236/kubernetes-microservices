...
import { PROJECT_DOMAIN, ENVIRONMENT, PROJECT_NAME, PROJECT_PROTOTYPE, INTERNAL_API_URL, PROJECT_SUPPORT_NAME, PROJECT_SUPPORT_EMAIL } from 'config/Configuration';
